  ...
  return (
    <div className="fixed bottom-5 right-5 z-50">
      <button
        ...
        className="group relative flex items-center justify-center bg-default-50 dark:bg-content1 rounded-full w-11 h-11 border border-divider shadow-[0_4px_14px_rgba(0,0,0,0.06)] dark:shadow-[0_6px_20px_rgba(0,0,0,0.25)] transition-all duration-200 hover:border-primary hover:shadow-[0_6px_18px_rgba(0,0,0,0.10)] dark:hover:shadow-[0_8px_26px_rgba(0,0,0,0.32)]"
        onClick={() => setTheme(theme === "dark" ? "light" : "dark")}
      >
        {/* subtle inner ring for cohesion */}
        <span className="pointer-events-none absolute inset-0 rounded-full ring-1 ring-divider" />
        <Icon
